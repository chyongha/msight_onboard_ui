    ...
    if position_exists:
        ...
        if position_speed_transmission is not None or position_speed_velocity is not None:
            ...
            if position_speed_transmission is None:
                ...
                # TransmissionAndSpeed SEQUENCE (used here and in ICAEncoder.py)
                # really does define this field as 'transmisson' in the actual
                # SAE J2735 standard — confirmed by round-tripping both spellings
                # through the real v2xlib.py: only 'transmisson' round-trips.
